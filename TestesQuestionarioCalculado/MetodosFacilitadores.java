...
public class MetodosFacilitadores {
    ...
    public void clicarAdicionarModuloSection(String nomeSecao) {
        List<WebElement> secoes = driver.findElements(By.className("course-section"));
        for(WebElement secao : secoes) {
            if(secao.findElement(By.className("course-section-header")).getText().contains(nomeSecao)) {
                secao.findElement(By.className("activity-add")).click();
                break;
            }
        }
    }
    ...
    public void clicarModulo(String nomeModulo) {
        List<WebElement> modulos = driver.findElements(By.className("card"));
    ...
    public void clicarExpandirTudo() {
        try {
            driver.findElement(By.className("collapsemenu")).click();
        } catch (Exception e) {
            System.out.println("Não foi possível clicar no botão expandir tudo");
        }
    ...
    public void clicarSalvarEMostrar() {

        driver.findElements(By.className("btn-primary")).get(1).click();
    }

    public void colocarNomeModulo(String mensagem) {
        driver.findElement(By.id("id_name")).sendKeys(mensagem);
    }
    ...
    public void clicarAdicionarQuestao() {
        driver.findElement(By.className("container-fluid")).findElement(By.tagName("a")).click();
    }
